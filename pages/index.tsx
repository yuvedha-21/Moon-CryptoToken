...
const Home: NextPage = () => {
  ...
  return isLoading() ? (
    ...
    <VStack minH="800px" w="full" bg={bg}>
      ...
      >
        <Slider value={SliderValue()} h="50px">
          <SliderTrack bg={sliderBG} h="25px" borderRadius={8}>
            ...
            <Center>
              <Text>{Number(tokensSold).toFixed()} / 75000 moon</Text>
            </Center>
          </SliderTrack>
        </Slider>
      </HStack>
      ...
      <Button bg="green.400" onClick={() => setIsOpen(true)}>
        BUY TOKENS
      </Button>
      <Box h="10px" />
      {/* Desktop */}
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalFooter>
            <Button bg="green.400" onClick={buyTokens}>
              BUY
            </Button>
          </ModalFooter>
        </ModalContent>
...
const HeaderFT = () => {
  return (
    <VStack>
      ...
      <HStack w="full">
        <Spacer />
        <Heading size="2xl">Moon Token</Heading>
        <Spacer />
      </HStack>
      <Box h="10px" />
    </VStack>
